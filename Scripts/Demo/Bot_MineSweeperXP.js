...
function parse_block(x, y)
{
    ...
    if (col == 0xc0c0c0) {
        ...
        switch(col) {
            case 0xff0000: result = 1; break;
            case 0x008000: result = 2; break;
            case 0x0000ff: result = 3; break; // red
            case 0x800000: result = 4; break;
            case 0x000080: result = 5; break; // brown
            case 0x808000: result = 6; break;
            case 0x000000:
            case 0xffffff:
                result = "*";
                is_dead = true;
