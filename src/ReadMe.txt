========================================================================
    STATIC LIBRARY : NaLib Project Overview
========================================================================

AppWizard has created this NaLib library project for you.

This file contains a summary of what you will find in each of the files that
make up your NaLib application.
...
StdAfx.h, StdAfx.cpp
    ...
    named NaLib.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "NaLib.rc" and a "NaLib.h" that
